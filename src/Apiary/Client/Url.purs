...
instance buildQueryParamsConsArray ::
  ...
  buildQueryParams _ params = query <> buildQueryParams (RLProxy :: _ paramTail) (coerceParams params)
    ...
    name = Url.encodeParam $ reflectSymbol name'

    query = (Tuple name <<< Url.encodeParam) <$> Record.get name' params
  ...
  buildQueryParams _ params = query <> buildQueryParams (RLProxy :: _ paramTail) (coerceParams params)
    ...
    query = maybe [] (pure <<< Tuple name <<< Url.encodeParam) $ Record.get name' params
